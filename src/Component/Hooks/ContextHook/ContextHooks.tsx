...
const UseContextHook: React.FC = () => {
    ...
    return <>
        <div className={`flex relative  h-fit flex-col gap-4 items-center px-3 py-6 rounded-lg shadow-xl  ${theme === 'light' ? "bg-white text-black" : "bg-black text-white shadow-white"}`}>
