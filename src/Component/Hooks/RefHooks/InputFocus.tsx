    ...
    return <>
        <div className="flex flex-col gap-4">
            <div className="flex justify-center">
                <input ref={FocusRef} type="text" value={textInput} placeholder="Click button for direct Focus " onChange={HandleInput} className="outline-black outline-8 border-2 border-gray-400 rounded-xl text-black px-4 w-72 sm:w-80 md:w-96 py-2 md:py-3" />
            </div>
