    ...
    return <>
        <div className="fixed bg-white z-50  h-20 shadow-lg w-full justify-between px-5 items-center flex">
            <div className="h-fit flex justify-center items-center gap-5 w-fit">
                <div onClick={() => dispatch(SliderStatus())} className="w-6 h-6 transition-all duration-500 ease-in-out relative flex justify-center items-center cursor-pointer flex-col gap-1">
